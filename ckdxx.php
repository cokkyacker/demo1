        ...
        <td width="833" class="tableBorder">
            ...
            <table width="100%" height="53" border="0" cellpadding="0"
                ...
                <tr align="center">
                    ...
                    <td width="10%" bgcolor="#87cee"><a href="SPersonalCenter.php"><font color="white"  size="3" >学生个人中心<br>
                                ...
                                <tr>
                                    <td width="100%" height="189" valign="top">
                                        ...
                                        <table width="95%" border="1" cellspacing="0"
                                            ...
                                            <tr><img src="images/19.JPG" width="100%" height="30%"></tr>
                                            <br> <br>
                                            <tr >
                                                ...
                                                <td align="center" width="7%">管理员编号</td>
                                                <td align="center" width="7%">创建时间</td>
                                            </tr>
                                            <?php
                                            $query="select * from studentinformation where id";		//从数据库中查询出有关学生的信息
                                            ...
                                            <tr align="center" width="95%">
                                                ...
                                                <td align="center" width="7%"><?php echo $myrow['title'];?>！</td>
                                                <td align="center" width="7%"><?php echo $myrow['content'];?></td>
                                                <td align="center" width="7%"><?php echo $myrow['state'];?></td>
                                                <td align="center" width="7%"><?php echo $myrow['anser'];?></td>
                                                <td align="center" width="7%"><?php echo $myrow['admin_id'];?></td>
