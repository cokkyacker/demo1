    ...
    <tr>
        <td width="833" class="tableBorder">
            ...
            <table width="100%" height="53" border="0" cellpadding="0"
                ...
                <tr align="center">
                    <td width="10%" bgcolor="#6495ed"><a href="index.html"><font color="white" size="3" >首页<br>
                                Index</a></td>
                    ...
                    <td width="10%" bgcolor="#6495ed"><a href="SPersonalCenter.html"><font color="white"  size="3" >学生个人中心<br>
                                                ...
                                                while($myrow=mysql_fetch_array($result)){  //通过while循环语句,把这些信息的内容进行输出
                                                    ...
                                                    <tr align="center" width="95%"><td align="center" width="10%"><?php echo $myrow['id'];?></td>
                                                        ...
                                                        <td>
                                                            ...
                                                            <?php echo "<a class='btw1' href='borrow.php? mid=".$myrow['id']."'>借出</a>" ?>
                                                            </div>
                                                        </td>
