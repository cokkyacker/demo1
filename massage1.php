                                    ...
                                    <td width="100%" height="189" valign="top">
                                        ...
                                        <table width="100%" border="1" cellspacing="0"
                                            ...
                                            <table width="100%"  border="0" cellspacing="-2" cellpadding="-2">
                                                <form action="php/xiugaiok.php?Tname=<?php echo $Tname ?>" method="post" >
                                                    <table width="94%"  border="0" cellpadding="0" cellspacing="0">
                                                        <tr align="center">
                                                            <td >短消息标题：<input name="title" type="text"></td>
                                                        </tr>
                                                        <tr align="center" >
                                                            <td class="tableBorder_B_dashed"  align="center"> 短消息内容：<textarea name="neirong" cols="50" rows="10"></textarea></td>
                                                        </tr>
                                                        <tr align="center">
                                                            <td align="center"><button name="xiaoxi1" type="submit" >提交</button></td></tr>
                                                        <br>
                                                        <br>
                                                        <br>
                                                        <tr>
