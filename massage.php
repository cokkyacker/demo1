                                    ...
                                    <td width="100%" height="189" valign="top">
                                        ...
                                        <table width="100%" border="1" cellspacing="0"
                                            ...
                                            <table width="100%"  border="0" cellspacing="-2" cellpadding="-2">
                                                <form action="php/xiugaiok.php?Sname=<?php echo $Sname ?>" method="post"   >
                                                    <table width="100%"  border="0" cellpadding="0" cellspacing="0">
                                                        <tr align="center">
                                                            <td >学生学号：<input name="student_cno" type="text"></td>
                                                        </tr>
                                                        ...
                                                        <tr align="center">
                                                           <td align="center"><button name="xiaoxi" type="submit"   >提交</button></td></tr>
                                                        <br>
                                                        <br>
                                                        <br>
                                                        <tr>
