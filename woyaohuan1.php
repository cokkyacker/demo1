                    ...
                    <td valign="top">
                        ...
                        <form>
                            ...
                            if(isset($_SESSION['Tname'])){
                                ...
                                // echo  $number ;
                                $state = "已还";
                                $query="select * from equipmentlease where teacher_id='".$number."' and state !='".$state."'";
                                // echo $query;
                                        ...
                                        <table width="95%" border="1" cellspacing="0"
                                            ...
                                            if($result){
                                                ...
                                                <tr >
                                                    ...
                                                    <td align="center" width="10%">教师号</td>
                                                ...
                                                while($myrow=mysql_fetch_array($result)){  //通过while循环语句,把这些信息的内容进行输出
                                                    ...
                                                    <tr align="center" width="95%">
                                                        ...
                                                        <td align="center" width="7%"><?php echo $myrow['teacher_id'];?></td>
                                                        ...
                                                        <td align="center" width="7%">
                                                            <div class='btw'>
                                                                ...
                                                                if($myrow['state'] == "审核中"||$myrow['state'] == "审核未通过") {
                                                                    echo "<a  class='btw1' href='php/guihuan1.php?mid=" . $myrow['id'] . "'>取消</a>"  ?>
                                                                <?php  } else{
                                                                    echo "<a  <a  class='btw1' href='php/guihuan1.php?mid=" . $myrow['id'] . "'>归还</a>"   ?>
                                                                <?php  } ?>
                                                            </div>
                                                        </td>
                                                    </tr>
