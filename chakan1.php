                                ...
                                <tr>
                                    <td width="100%" height="189" valign="top">
                                        ...
                                        <form action="#" method="post" name="myform">
                                            ...
                                            $query="select * from teacher where number='".$number."' ";		//从数据库中查询出有关学生的信息
                                            $result=mysql_query($query);
                                            $myrow=mysql_fetch_array($result)
                                            ?>
                                            <table width="100%"  border="0" cellspacing="-2" cellpadding="-2">
                                                <tr align="center"><td align="center">工号：<?php echo $myrow['number'];?></td></tr>
                                                ...
                                                <tr><td align="center" bgcolor="#87cefa"><a href="TPersonalCenter.php">返回</a></td></tr>
                                            </table>
                                        </form>
                                    </td>
                                </tr>
