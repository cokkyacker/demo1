                                ...
                                <tr>
                                    <td width="100%" height="150" valign="top" >
                                        ...
                                        <table width="95%" border="0" cellspacing="0" align="center"
                                            ...
                                            $query="select * from notice where nid='$b' ";

                                            $result=mysql_query($query);
                                            $myrow=mysql_fetch_array($result)
                                            ?>

                                            <tr align="center" >标题：<?php echo $myrow['ntitle'];?></tr><br><br>
                                            <tr>内容：<?php echo $myrow['ncontent'];?></tr><br><br>
                                            <tr align="center">时间：<?php echo $myrow['ntime'];?></tr><br><br>
                                            <tr align="center">发布者：<?php echo $myrow['admin_id'];?></tr><br><br>
                                            <tr><td align="center" bgcolor="#87cefa"><a href="index1.php">返回</a></td></tr>
