                                ...
                                <tr>
                                    <td width="100%" height="189" valign="top">
                                        ...
                                        <table width="100%" border="1" cellspacing="0"
                                            ...
                                            <tr><img src="images/21.JPG" width="100%" height="30%"></tr>
                                        </table>
                                        <?php
                                        $number=$_SESSION['Tname'];
                                        ?>
                                        <form action="php/xiugaiok.php?number=<?php echo $number ?>" method="post" name="xiugai1">
                                            <table width="100%"  border="0" cellspacing="-2" cellpadding="-2">
                                                ...
                                                <tr>
                                                    <td height="34">&nbsp;</td>
                                                    <td class="word_grey">
                                                        <button name="xiugai1" type="submit" class="btn_grey" >确定保存</button>
