...
<html class="x-admin-sm">
    ...
    <body>
        <div class="layui-fluid">
            <div class="layui-row">
                <form action="php/xiugai_ok.php?id=<?php echo $id ?>" method="post" name="xiugai1" class="layui-form">
                    ...
                    <div class="layui-form-item">
                        ...
                        <button class="layui-btn" name="xiugai1" type="submit"  lay-submit="">修改</button></div>
                </form>
            </div>
        </div>
