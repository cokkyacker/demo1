...
if($myrow['number']>=$number) {
    $query = "insert into equipmentlease(state,time,btime,equipment_id,student_id,admin_id,remark,number)
        values('审核中','$time','$btime','$equipment_id','$student_id','$admin_id','$remarks','$number')";
    ...
    if (mysql_query($query)) {
        echo "<script>alert('添加成功！');window.location.href='../jhqk.php'</script>";
        // mysqli_close($conn);
