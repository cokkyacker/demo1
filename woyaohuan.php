            ...
            <table width="100%" height="53" border="0" cellpadding="0"
                ...
                <tr align="center">
                    ...
                    <td width="10%" bgcolor="#6495ed"><a href="Equipment.php"><font color="white"  size="3" >设备器材<br>
                        Equipment</a></td>
                    <td width="15%" bgcolor="#87ceeb"><a href="EquipmentBorrow.html"><font color="white"  size="3" >设备借还<br>
                        EquipmentBorrow</a></td>
                    <td width="10%" bgcolor="#6495ed"><a href="SPersonalCenter.php"><font color="white"  size="3" >学生个人中心<br>
                    ...
                    <td valign="top">
                        ...
                        <form>
                                ...
                                if(isset($_SESSION['Sname'])){
                                    ...
                                    // echo  $number ;
                                    $state = "已还";
                                    $query="select * from equipmentlease where student_id='".$number."' and state !='".$state."'";
                                   // echo $query;
                                        ...
                                        <table width="95%" border="1" cellspacing="0"
                                            ...
                                            if($result){
                                                ...
                                                <tr >
                                                    ...
                                                    <td align="center" width="7%">设备编号</td>
                                                    <td align="center" width="7%">状态</td>
                                                    <td align="center" width="7%">数量</td>
                                                    <td align="center" width="7%">创建时间</td>
                                                    <td align="center" width="7%">归还时间</td>
                                                    <td align="center" width="7%">归还</td>
                                                </tr>
                                                <?php
                                                while($myrow=mysql_fetch_array($result)){  //通过while循环语句,把这些信息的内容进行输出
                                                    ?>
                                                    <tr align="center" width="95%">
                                                        <td align="center" width="10%"><?php echo $myrow['id'];?></td>
                                                        <td align="center" width="7%"><?php echo $myrow['student_id'];?></td>
                                                        <td align="center" width="7%"><?php echo $myrow['equipment_id'];?></td>
                                                        <td align="center" width="7%"><?php echo $myrow['state'];?></td>
                                                        <td align="center" width="7%"><?php echo $myrow['number'];?></td>
                                                        <td align="center" width="7%"><?php echo $myrow['time'];?></td>
                                                        <td align="center" width="7%"><?php echo $myrow['btime'];?></td>
                                                        <td align="center" width="7%">
                                                            <div class='btw'>
                                                            <?php
                                                        if($myrow['state'] == "审核中"||$myrow['state'] == "审核未通过") {
                                                                echo "<a  class='btw1' href='php/guihuan.php?mid=" . $myrow['id'] . "'>取消</a>"  ?>
                                                        <?php  } else{
                                                           echo "<a  <a  class='btw1' href='php/guihuan.php?mid=" . $myrow['id'] . "'>归还</a>"   ?>
                                                            <?php  } ?>
                                                            </div>
                                                        </td>
                                                    </tr>
