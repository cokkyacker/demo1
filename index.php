...
if(!isset($_SESSION['Sname']) && !isset($_SESSION['Spassword'])){
	echo "请先登录,才可以访问页面!!";
	echo "<meta http-equiv=\"Refresh\" content=\"2;url=StudentLogin.html\">";
}else{
?>
<html>
<head>
    ...
    <tr>
        <td width="833" class="tableBorder">
            ...
            <table width="100%" height="53" border="0" cellpadding="0"
                ...
                <tr align="center">
                    <td width="10%" bgcolor="#87ceeb"><a href="index.html"><font color="white" size="3">首页<br>
                                Index</a></td>
                    <td width="10%" bgcolor="6495ed"><a href="Equipment.php"><font color="white" size="3">设备器材<br>
                                Equipment</a></td>
                    <td width="15%" bgcolor="6495ed"><a href="EquipmentBorrow.html"><font color="white"
                                                                                          size="3">设备借还<br>
                                EquipmentBorrow</a></td>
                    <td width="10%" bgcolor="6495ed"><a href="SPersonalCenter.php"><font color="white"
                                                                                         size="3">学生个人中心<br>
                ...
                <tr>
                                        ...
                                        <tr>
                                            <td width="100%" valign="baseline">
                                                <table width="100%" border="0" cellpadding="0"
                                                       cellspacing="0">
                                                    <tr>
                                                        <td width="94%" height="24" align="center"><a
                                                                    href="Guizhang.html">
                        ...
                        <table width="100%" height="377" border="0" cellpadding="0"
                            ...
                            <tr>
                                <td height="337" align="center" valign="top" class="tableBorder_lb">
                                    <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                        <tr>
                                            <td class="tableBorder_B_dashed" bgcolor="#d3d3d3" align="center">
                    ...
                    <td valign="top">
                            ...
                            <tr>
                                ...
                                <td width="505" height="33" align="right" valign="middle">
                                    <table width="100%" height="24" border="0" cellpadding="0"
                                        ...
                                        <tr>
                                            <td align="right" class="word_green" width="500" height="100%">
                                ...
                                <td colspan="2">
                                    ...
                                    <form name="form2" method="post" action="#">
                                        <table width="100%" height="23" border="0" cellpadding="0"
                                            ...
                                            <tr>
                                                <td colspan="2" height="7" align="center"></td>
                                            </tr>
                                            <tr>
                        ...
                        <form action="#" method="post" name="news">
                            <?php
                            $query = "select * from notice  order by case when(IsOpen='1') then 0 else 1 end,ntime desc";
                                ...
                                <tr>
                                    <td width="100%" height="150" valign="top">
                                        ...
                                        <table width="95%" border="1" cellspacing="0" align="center"
                                            ...
                                            <tr><img src="images/13.JPG" width="100%" height="30%"></tr>
                                            <br> <br>
                                            <tr>
                                                <td align="center" width="10%">编号</td>
                                                <td align="center" width="30%">标题</td>
                                                <td align="center" width="15%">置顶状态</td>
                                                <td align="center" width="15%">创建时间</td>
                                                <td align="center" width="15%">管理员编号</td>
                                            </tr>
                                            ...
                                            while ($myrow = mysql_fetch_array($result)) {  //通过while循环语句,把这些信息的内容进行输出
                                                ...
                                                <tr align="center" width="95%">
                                                    <td align="center" width="10%" ><?php echo $myrow['nid']; ?></td>
                                                    <td align="center" width="30%"><a href='neirong.php?nid=<?php echo $myrow['nid']; ?>'><?php echo $myrow['ntitle']; ?></a></td>


                                                    <td align="center"
                                                        width="15%"><?php echo $myrow['toppingstate']; ?></td>
                                                    <td align="center" width="15%"><?php echo $myrow['ntime']; ?></td>
                                                    <td align="center"
                                                        width="15%"><?php echo $myrow['admin_id']; ?></td>
                ...
                <tr>
                    <td>
                        ...
                        <table width="100%" height="80" border="0" align="center"
                            ...
                            <tr>
                                <td colspan="3" align="center" bgcolor="6495ed" width="100%"><font color="white"
                                                                                                   size="3.5">
