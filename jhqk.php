                    ...
                    <td valign="top">
                        ...
                        <form action="#" method="post" name="myform">
                            ...
                            $number = $_SESSION['Sname'];
                             // echo  $number ;
                            $query="select * from equipmentlease where student_id=$number";
                                    ...
                                    <td width="100%" height="189" valign="top">
                                        ...
                                        <table width="95%" border="1" cellspacing="0"
                                            ...
                                            <tr >
                                                ...
                                                <td align="center" width="7%">备注用途</td>
                                                <td align="center" width="7%">借入时间</td>
                                                <td align="center" width="7%">预计归还时间</td>
                                            </tr>
                                                <?php
                                            ...
                                            <tr align="center" width="95%">
                                                ...
                                                <td align="center" width="7%"><?php echo $myrow['remark'];?></td>
