    ...
    <tr>
        <td width="833" class="tableBorder">
            ...
            <table width="100%" height="53" border="0" cellpadding="0"
                ...
                <tr align="center">
                    <td width="10%" bgcolor="#87ceeb"><a href="index1.php"><font color="white" size="3" >首页<br>
                        Index</a></td>
            ...
            <table width="100%" height="50" border="1"
                ...
                <tr>
                    ...
                    <td valign="top">
                        ...
                        <form action="#" method="post" name="news1">
                            <?php
                                ...
                                <tr>
                                    <td width="100%" height="150" valign="top" >
                                        ...
                                        <table width="95%" border="1" cellspacing="0" align="center"
                                            ...
                                            <br>  <br>
                                            <tr><td align="center" width="10%">编号</td>
                                            ...
                                            while ($myrow = mysql_fetch_array($result)) {  //通过while循环语句,把这些信息的内容进行输出
                                                ...
                                                <tr align="center" width="95%">
                                                    ...
                                                    <td align="center" width="30%"><a href='neirong1.php?nid=<?php echo $myrow['nid']; ?>'><?php echo $myrow['ntitle']; ?></a></td>
