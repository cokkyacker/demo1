    ...
    <tr>
        <td width="833" class="tableBorder">
            ...
            <table width="100%" height="53" border="0" cellpadding="0"
                ...
                <tr align="center">
                    <td width="10%" bgcolor="#6495ed"><a href="index1.html"><font color="white" size="3" >首页<br>
                                Index</a></td>
                    ...
                    <td width="10%" bgcolor="#6495ed"><a href="TPersonalCenter.html"><font color="white"  size="3" >教师个人中心<br>
                                                    ...
                                                    <tr align="center" width="95%"><td align="center" width="10%"><?php echo $myrow['id'];?></td>
                                                        ...
                                                        <td>
                                                            <div class="btw">
                                                                ...
                                                                <?php echo "<a class='btw1' href='borrow1.php? mid=".$myrow['id']."'>借出</a>" ?>
                                                            </div>
                                                        </td>
