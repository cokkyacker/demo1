...
if(!isset($_SESSION['Tname']) && !isset($_SESSION['Tpassword'])){
    echo "请先登录,才可以访问页面!!";
    echo "<meta http-equiv=\"Refresh\" content=\"2;url=TeacherlLogin.html\">";
}else{
?>
<html>
<head>
        ...
        <td width="833" class="tableBorder">
            ...
            <table width="100%" height="53" border="0" cellpadding="0"
                ...
                <tr align="center">
                    ...
                    <td width="10%" bgcolor="#87ceeb"><a href="TPersonalCenter.php"><font color="white"  size="3" >教师个人中心<br>
                                ...
                                <tr>
                                    <td width="100%" height="189" valign="top">
                                        ...
                                        <table width="100%" border="1" cellspacing="0"
                                            ...
                                            <tr><img src="images/27.JPG" width="100%" height="30%"></tr>
                                        </table>
                                        <?php
                                        $number=$_SESSION['Tname'];
                                        ?>
                                        <form action="php/xiugaiok.php?number=<?php echo $number ?>" method="post" name="myform">
                                            <table width="100%"  border="0" cellspacing="-2" cellpadding="-2">
                                                <tr>
                                                    <td height="28" align="center">QQ号：</td>
                                                    <td height="28"><input name="qqnumber"  size="20" maxlength="20">
                                                        <span class="word_orange">*</span></td>
                                                </tr>
                                                <tr>
                                                    <td height="28" align="center">手机号：</td>
                                                    <td height="28"><input name="phone"  size="20" maxlength="20">
                                                        <span class="word_orange">*</span></td>
                                                </tr>
                                                <tr>
                                                    <td height="28" align="center">Email：</td>
                                                    <td height="28"><input name="email"  size="20" maxlength="20">
                                                        <span class="word_orange">*</span></td>
                                                </tr>
                                                <tr>
                                                    <td height="34">&nbsp;</td>
                                                    <td class="word_grey"><button name="wanshan1" type="submit" class="btn_grey" >确定保存</button>
                                                        <input name="Submit2" type="reset" class="btn_grey" value="重新填写">
                                                        <input name="Submit22" type="button" class="btn_grey" value="返回" onClick="window.location.href='TPersonalCenter.php'">
                                                    </td>
                                                </tr>
                                            </table>
                                        </form>
